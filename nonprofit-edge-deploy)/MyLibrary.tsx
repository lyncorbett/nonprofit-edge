...
import { 
  ...
  BookOpen, Target, Users, BarChart3, Briefcase
} from 'lucide-react';
...
const MyLibrary: React.FC<MyLibraryProps> = ({ onNavigate }) => {
  const [activeTab, setActiveTab] = useState<'assessments' | 'downloads' | 'favorites'>('assessments');
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <svg width="160" height="45" viewBox="0 0 500 140" fill="none">
                ...
                <text x="115" y="115" fontFamily="system-ui" fontSize="32" fontWeight="800" fill="#0D2C54">EDGE</text>
              </svg>
            </button>
            <span className="text-slate-300">|</span>
            <div>
              <h1 className="text-lg font-bold text-[#0D2C54]">My Library</h1>
              <p className="text-sm text-slate-500">Your assessments, downloads, and saved resources</p>
            </div>
          </div>
          <button
            onClick={() => navigate('dashboard')}
