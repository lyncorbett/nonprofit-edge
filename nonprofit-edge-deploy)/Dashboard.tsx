  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className="w-[280px] bg-white border-r border-slate-200 p-6 flex flex-col fixed top-0 left-0 h-screen overflow-y-auto">
        {/* Logo - SVG version */}
        <div className="mb-8">
          <svg width="200" height="56" viewBox="0 0 500 140" fill="none">
            <g transform="translate(0, 10)">
              <path d="M60 10 A50 50 0 1 1 20 70" stroke="#0D2C54" strokeWidth="8" fill="none" strokeLinecap="round"/>
            ...
            <text x="115" y="42" fontFamily="system-ui, -apple-system, sans-serif" fontSize="28" fontWeight="700" fill="#0D2C54">THE</text>
            <text x="115" y="78" fontFamily="system-ui, -apple-system, sans-serif" fontSize="32" fontWeight="800" fill="#0097A9">NONPROFIT</text>
            <text x="115" y="115" fontFamily="system-ui, -apple-system, sans-serif" fontSize="32" fontWeight="800" fill="#0D2C54">EDGE</text>
          </svg>
        </div>
