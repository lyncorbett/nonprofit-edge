        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-xl shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
              <div className="p-2">
                <Link to="/tools/strategic-plan-analysis" className="block px-4 py-3 rounded-lg hover:bg-gray-50">
                ...
                <Link to="/tools/grant-review" className="block px-4 py-3 rounded-lg hover:bg-gray-50">
                ...
                <Link to="/tools/scenario-planning" className="block px-4 py-3 rounded-lg hover:bg-gray-50">
                ...
                <Link to="/tools/ceo-evaluation" className="block px-4 py-3 rounded-lg hover:bg-gray-50">
                ...
                <Link to="/tools/board-assessment" className="block px-4 py-3 rounded-lg hover:bg-gray-50">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4">
          <div className="space-y-2">
            ...
            <Link to="/tools/strategic-plan-analysis" className="block py-2 text-gray-600">Strategic Plan Analysis</Link>
            <Link to="/tools/grant-review" className="block py-2 text-gray-600">Grant Review</Link>
            <Link to="/tools/scenario-planning" className="block py-2 text-gray-600">Strategy & Scenario Planning</Link>
            <Link to="/tools/ceo-evaluation" className="block py-2 text-gray-600">CEO Evaluation</Link>
            <Link to="/tools/board-assessment" className="block py-2 text-gray-600">Board Assessment</Link>
          </div>
